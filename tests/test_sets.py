...
class TestSetDatabase(unittest.TestCase):
    ...
    def test_core_sets(self):
        ...
        self.e('4ED', ['Fourth Edition', '4th Edition', '4E'])
        self.e('4EA', ['Alternate Fourth Edition', 'Alternate 4th Edition'])
        self.e('5ED', ['Fifth Edition', '5th Edition', '5E'])
        self.e('6ED', ['Sixth Edition', '6th Edition', '6E', 'Classic Sixth Edition'])
        self.e('7ED', ['Seventh Edition', '7th Edition', '7E'])
        self.e('8ED', ['Eighth Edition', '8th Edition', '8E', 'Eighth Edition Box Set', '8EB'])
        self.e('9ED', ['Ninth Edition', '9th Edition', '9E', 'Ninth Edition Box Set', '9EB'])
        self.e('10E', ['Tenth Edition', '10th Edition'])
        self.e('M10', ['Magic 2010', 'Magic 2010 (M10)', 'Magic 2010 Core Set', '2010 Core Set', 'Core Set 2010', 'Синглы M10'])
        self.e('M11', ['Magic 2011', 'Magic 2011 (M11)', 'Magic 2011 Core Set', '2011 Core Set', 'Core Set 2011', 'Синглы M11'])
        self.e('M12', ['Magic 2012', 'Magic 2012 (M12)', 'Magic 2012 Core Set', '2012 Core Set', 'Core Set 2012', 'Синглы M12'])
        self.e('M13', ['Magic 2013', 'Magic 2013 (M13)', 'Magic 2013 Core Set', '2013 Core Set', 'Core Set 2013', 'Синглы M13'])
        self.e('M14', ['Magic 2014', 'Magic 2014 (M14)', 'Magic 2014 Core Set', '2014 Core Set', 'Core Set 2014', 'Синглы M14'])
        self.e('M15', ['Magic 2015', 'Magic 2015 (M15)', 'Magic 2015 Core Set', '2015 Core Set', 'Core Set 2015', 'Синглы M15'])
        self.e('M19', ['Magic 2019', 'Magic 2019 (M19)', 'Magic 2019 Core Set', '2019 Core Set', 'Core Set 2019', 'Синглы M19'])
        self.e('ORI', ['Magic Origins', 'Origins'])

    def test_expansion_sets(self):
        self.e('ARN', ['Arabian Nights'])
        self.e('ATQ', ['Antiquities'])
        self.e('LEG', ['Legends'])
        self.e('DRK', ['The Dark', 'DK'])
        self.e('FEM', ['Fallen Empires', 'FE'])
        self.e('HML', ['Homelands', 'HL'])

        self.e('MIR', ['Mirage'])
        self.e('VIS', ['Visions', 'VI'])
        self.e('WTH', ['Weatherlight', 'WL'])

        self.e('TMP', ['Tempest', 'TE'])
        self.e('STH', ['Stronghold', 'SH'])
        self.e('EXO', ['Exodus', 'EX'])

        self.e('USG', ["Urza's Saga", 'US'])
        self.e('ULG', ["Urza's Legacy", 'UL'])
        self.e('UDS', ["Urza's Destiny", 'UD'])

        self.e('MMQ', ['Mercadian Masques', 'MM'])
        self.e('NEM', ['Nemesis', 'NE', 'NMS'])
        self.e('PCY', ['Prophecy', 'PY', 'PR'])

        self.e('INV', ['Invasion', 'IN'])
        self.e('PLS', ['Planeshift', 'PS'])
        self.e('APC', ['Apocalypse', 'AP'])

        self.e('ODY', ['Odyssey', 'OD'])
        self.e('TOR', ['Torment', 'TO', 'TR'])
        self.e('JUD', ['Judgment', 'JU', 'Judgement'])

        self.e('ONS', ['Onslaught', 'ON'])
        self.e('LGN', ['Legions'])
        self.e('SCG', ['Scourge', 'SC'])

        self.e('MRD', ['Mirrodin'])
        self.e('DST', ['Darksteel', 'DS'])
        self.e('5DN', ['Fifth Dawn', 'FD'])

        self.e('CHK', ['Champions of Kamigawa', 'CK'])
        self.e('BOK', ['Betrayers of Kamigawa', 'BK'])
        self.e('SOK', ['Saviors of Kamigawa', 'SK'])

        self.e('RAV', ['Ravnica: City of Guilds', 'Ravnica', 'RA'])
        self.e('DIS', ['Dissension', 'DI'])
        self.e('GPT', ['Guildpact', 'GP'])

        self.e('ICE', ['Ice Age', 'IA'])
        self.e('ALL', ['Alliances', 'AL'])
        self.e('CSP', ['Coldsnap', 'CS'])

        self.e('TST', ['Time Spiral Timeshifted', 'TSTS', 'Timeshifted'])
        self.e('TSP', ['Time Spiral', 'TS'])
        self.e('PLC', ['Planar Chaos', 'PC', 'PCH'])
        self.e('FUT', ['Future Sight', 'FS'])

        self.e('LRW', ['Lorwyn', 'LW', 'LOR'])
        self.e('MOR', ['Morningtide', 'MT'])

        self.e('SHM', ['Shadowmoor', 'SM'])
        self.e('EVE', ['Eventide', 'ET'])

        self.e('ALA', ['Shards of Alara', 'SA'])
        self.e('CON', ['Conflux', 'CF', 'CFX'])
        self.e('ARB', ['Alara Reborn', 'AR'])

        self.e('ZEN', ['Zendikar'])
        self.e('WWK', ['Worldwake'])
        self.e('ROE', ['Rise of the Eldrazi'])

        self.e('SOM', ['Scars of Mirrodin'])
        self.e('MBS', ['Mirrodin Besieged'])
        self.e('NPH', ['New Phyrexia'])

        self.e('ISD', ['Innistrad'])
        self.e('DKA', ['Dark Ascension'])
        self.e('AVR', ['Avacyn Restored'])

        self.e('RTR', ['Return to Ravnica', 'Retun to Ravnica'])
        self.e('GTC', ['Gatecrash'])
        self.e('DGM', ["Dragon's Maze"])

        self.e('THS', ['Theros'])
        self.e('BNG', ['Born of the Gods', 'BOG'])
        self.e('JOU', ['Journey into Nyx'])

        self.e('KTK', ['Khans of Tarkir'])
        self.e('FRF', ['Fate Reforged'])
        self.e('DTK', ['Dragons of Tarkir'])

        self.e('BFZ', ['Battle for Zendikar'])
        self.e('OGW', ['Oath of the Gatewatch'])

        self.e('SOI', ['Shadows over Innistrad'])
        self.e('EMN', ['Eldritch Moon'])

        self.e('KLD', ['Kaladesh'])
        self.e('AER', ['Aether Revolt'])

        self.e('AKH', ['Amonkhet'])
        self.e('HOU', ['Hour of Devastation'])

        self.e('XLN', ['Ixalan'])
        self.e('RIX', ['Rivals of Ixalan'])

        self.e('DOM', ['Dominaria'])
    ...
    def test_special_sets(self):
        ...
        self.e('E02', ['Explorers of Ixalan'])
