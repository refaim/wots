...
class TestSetOracle(OracleTest):
    ...
    def test_expansion_sets(self):
        ...
        self.e('BNG', ['Born of the Gods', 'BOG', 'Порождения Богов', 'Born of Gods'])
        self.e('JOU', ['Journey into Nyx', 'Путешествие в Никс', 'Jorney into Nyx'])
    ...
    def test_special_sets(self):
        ...
        self.e('DAE', ['Duel Decks Anthology: Elves vs. Goblins', 'Duel Decks: Elves vs. Goblins (Anthology)', 'Anthology, Elves vs. Goblins'])
        self.e('DAJ', ['Duel Decks Anthology: Jace vs. Chandra', 'Duel Decks: Jace vs. Chandra (Anthology)', 'Anthology, Jace vs. Chandra'])
        self.e('DAD', ['Duel Decks Anthology: Divine vs. Demonic', 'Duel Decks: Divine vs. Demonic (Anthology)', 'Anthology, Divine vs. Demonic'])
        self.e('DAG', ['Duel Decks Anthology: Garruk vs. Liliana', 'Duel Decks: Garruk vs. Liliana (Anthology)', 'Anthology, Garruk vs. Liliana'])
