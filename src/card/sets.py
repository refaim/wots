...
_SET_ABBREVIATIONS_SOURCE = {
    ...
    'ARB': ('Alara Reborn', 'AR',),
    'ARC': ('Archenemy',),
    'ARL': ('Arena League', 'Arena', 'Arena/Colosseo Leagues Promos',),
    'ARN': ('Arabian Nights',),
    'AST': ('Astral',),
    'ATH': ('Anthologies',),
    'ATQ': ('Antiquities',),
    ...
    'JRW': ('Judge Rewards', 'Judge Gift Cards',),
    'JSS': ('Junior Super Series', 'Junior Series Promos',),
    ...
    'MBP': ('Media Inserts', 'Media Promos',),
    'MBS': ('Mirrodin Besieged',),
    'MD1': ('Modern Event Deck', 'Modern Event Deck 2014', 'Magic Modern Event Deck',),
    'MGB': ('Multiverse Gift Box',),
    'MGD': ('Magic Game Day Cards', 'Magic Game Day', 'Game Day', 'Game Day Promos', 'pMGD',),
    'MIR': ('Mirage',),
    ...
    'MRD': ('Mirrodin',),
    'MS1': ('Kaladesh Inventions', 'Masterpiece Series: Kaladesh Inventions'),
    'MSP': ('Misc Promos', 'Stores Promos', 'Convention Promos', 'Comic Inserts', 'Full Box Promotion', 'Box Topper Cards', 'Magazine Inserts', 'Book Inserts', 'Video Game Promos',),
    'NEM': ('Nemesis', 'NE',),
    'NPH': ('New Phyrexia',),
    'ODY': ('Odyssey', 'OD',),
    ...
    'POR': ('Portal',),
    'PRL': ('Prerelease, Release & Launch Party Cards', 'Prerelease & Release Cards', 'Prerelease Events', 'Release Events', 'Prerelease Promos', 'Release & Launch Parties Promos', 'Magic: The Gathering Launch Parties',),
    'PRO': ('Pro Tour Promos',),
    ...
    'WMC': ('World Magic Cup Qualifiers Promos', 'World Magic Cup Qualifiers',),
    'WPN': ('WPN\\Gateway', 'WPN/Gateway', 'Gateway & WPN Promos',),
    'WTH': ('Weatherlight', 'WL',),
    'WWK': ('Worldwake',),
    'ZEN': ('Zendikar',),
}
