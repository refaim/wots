...
_SET_ABBREVIATIONS_SOURCE = {
    ...
    'CHP': ('Champs Promos', 'Champs Promo',),
    'CHR': ('Chronicles',),
    ...
    'POR': ('Portal',),
    'PRL': ('Prerelease, Release & Launch Party Cards', 'Prerelease & Release Cards', 'Prerelease Events', 'Release Events', 'Prerelease Promos', 'Release & Launch Parties Promos', 'Magic: The Gathering Launch Parties', 'PreRelease', 'Release', 'Launch Party',),
    'PRO': ('Pro Tour Promos',),
    ...
    'WPN': ('WPN\\Gateway', 'WPN/Gateway', 'Gateway & WPN Promos', 'Wizards Play Network', 'Gateway', 'Gateway Promo',),
    'WTH': ('Weatherlight', 'WL',),
    'WWK': ('Worldwake',),
    'ZEN': ('Zendikar',),
}
