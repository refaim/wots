...
_SET_ABBREVIATIONS_SOURCE = {
    ...
    '3ED': ('Revised Edition', '3E', 'Revised', 'Revised Edition (FBB)',),
    '4ED': ('Fourth Edition', '4th Edition', '4E', '4th Edition (FBB)',),
    '5DN': ('Fifth Dawn', 'FD',),
    ...
    'MRD': ('Mirrodin',),
    'MSC': ('Misc Promos', 'Stores Promos', 'Convention Promos', 'Comic Inserts', 'Full Box Promotion', 'Box Topper Cards', 'Magazine Inserts', 'Junior Series Promos', 'Book Inserts', 'Video Game Promos',),
    'NEM': ('Nemesis', 'NE',),
    'NPH': ('New Phyrexia',),
    'ODY': ('Odyssey', 'OD',),
